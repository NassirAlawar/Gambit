...
registered_gambits = {
    ...
    Gambits.multi_condition_trigger.cond(
        {
            Gambits.is_engaged.cond(),
            Gambits.ma_recast_ready_cond.cond("Blizzaga")
        },
        use_command("Blizzaga", "t")
    ),

    Gambits.multi_condition_trigger.cond(
        {
            Gambits.is_engaged.cond(),
            Gambits.ma_recast_ready_cond.cond("Blizzaga II")
        },
        use_command("Blizzaga II", "t")
    ),

    Gambits.multi_condition_trigger.cond(
        {
            Gambits.is_engaged.cond(),
            Gambits.ma_recast_ready_cond.cond("Blizzaga III")
        },
        use_command("Blizzaga III", "t")
    ),

    Gambits.multi_condition_trigger.cond(
        {
            Gambits.is_engaged.cond(),
            Gambits.ma_recast_ready_cond.cond("Blizzaja")
        },
        use_command("Blizzaja", "t")
    ),
