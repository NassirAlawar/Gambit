...
registered_gambits = {
    ...
    Gambits.ja_recast_ready.cond("Counterstance", use_command('Counterstance', "me")),
    Gambits.ja_recast_ready.cond("Impetus", use_command('Impetus', "me")),
